...
# Add custom plugins
RUN true \
    && wget -O /usr/lib/nagios/plugins/check-speedtest https://raw.githubusercontent.com/samjaseu/check-speedtest/master/check-speedtest \
    && chmod 755 /usr/lib/nagios/plugins/check-speedtest
